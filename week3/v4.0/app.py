...
def etag_for_collection() -> str:
    snapshot = sorted(BOOKS, key=lambda x: x["id"])
...
def delete_book(book_id):
    _, err_resp = require_jwt(required_role="librarian")
    if err_resp: return err_resp
